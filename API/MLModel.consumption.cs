...
namespace API
{
    public partial class MLModel
    {
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"Classificação")]
            public uint Classificação { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Classificação");
            if (labelColumn == null)
            {
                throw new Exception("Classificação column not found. Make sure the name searched for matches the name in the schema.");
            }
